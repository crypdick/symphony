defmodule SymphonyElixir.PromptBuilder do
  ...
  - Prefer subagents for Scout, Review, and focused validation-failure diagnosis. The main thread should synthesize their compact findings, not paste their full transcripts.
